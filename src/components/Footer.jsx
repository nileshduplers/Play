...
function Footer() {
  ...
  const footerproductNavItems = [
    { label: "LineIcons", url: "/" },
    { label: "Ecommerce HTML", url: "/" },
    { label: "TailAdmin", url: "/Terms of Service" },
    { label: "PlainAdmin", url: "/Refund policy" },
  ];
        ...
        <div className="-mx-4 flex flex-wrap">
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
            <div className="mb-10 w-full">
              ...
              <Footer_nav items={footerNavItems} />
            </div>
          </div>
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
            <div className="mb-10 w-full">
              ...
              <Footer_nav items={footerfeatureNavItems} />
            </div>
          </div>
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-3/12">
            <div className="mb-10 w-full">
              ...
              <Footer_nav items={footerproductNavItems} />
            </div>
          </div>
        </div>
      </div>
